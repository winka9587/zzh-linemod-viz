...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num, add_noise, root, noise_trans, refine, obj):
        self.lm_obj_list = {
            'ape': 1,
            'benchvise': 2,
            'cam': 4,
        ...
        self.objlist = []
        self.objlist.append(self.lm_obj_list[obj])
        ...
        for item in self.objlist:
            ...
            #self.choose_pt[item] = farthest_point_sampling(self.pt[item], num)
    ...
    def __getitem__(self, index):
        ...
        K = np.array([[572.4114, 0.,         325.2611],
                       ...
                       [0.,        0.,         1.]])
        dpt_mm = depth.copy().astype(np.uint16)
        ...
        #model_choose = model_points[self.choose_pt[obj]]
        ...
        poses = np.hstack((target_r, (target_t/1000.0).reshape(3,1)))
        ...
        return torch.from_numpy(cloud.astype(np.float32)), \
               ...
               #torch.from_numpy(out_t.astype(np.float32)) 
