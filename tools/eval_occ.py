...
from lib.network import PoseNet, PoseRefineNet, PoseNet_trans, PoseRefineNet_trans
...
# --dataset_root /data1/zzh/OCCLUSION_LINEMOD\
...
parser.add_argument('--dataset_root', type=str, default='/data1/zzh/OCCLUSION_LINEMOD', help='dataset root dir')
# parser.add_argument('--model', type=str, default='/data1/zzh/DenseFusion-Pytorch-1.0/trained_models/linemod_ape/pose_model_5_0.006174322933601659.pth',  help='resume PoseNet model')
# parser.add_argument('--refine_model', type=str, default='/data1/zzh/DenseFusion-Pytorch-1.0/trained_models/linemod_ape/pose_refine_model_11_0.00457129196823752.pth',  help='resume PoseRefineNet model')

parser.add_argument('--model', type=str, default='/data1/zzh/DenseFusion-Pytorch-1.0/trained_models/linemod_DF/no_refine_pose_model_15_0.011377632944034037.pth',  help='resume PoseNet model')
parser.add_argument('--refine_model', type=str, default='/data1/zzh/DenseFusion-Pytorch-1.0/trained_models/linemod_DF/pose_refine_model_52_0.008157194164999158.pth',  help='resume PoseRefineNet model')
...
#testdataset = Dataset_linemod('test', True, 0.0, 'cam', DEBUG=True)
testdataset = Occ_linemod(mode='all', num=500, root_path='/data1/zzh/OCCLUSION_LINEMOD')
...
for i, data in enumerate(testdataloader, 0):
    ...
    # cv2.waitKey(0)
    save_path = f"/data1/zzh/occ_DF_img/{img_idx}.png"
    if save:
...
print('Object  success rate: {0}'.format( float(success_count[idx[0].item()]) / num_count[idx[0].item()]))
# fw.write('Object success rate: {0}\n'.format( float(success_count[idx[0].item()]) / num_count[idx[0].item()]))
#
# fw.close()
